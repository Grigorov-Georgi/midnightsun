  ...
  return (
    <Card className='product-details'>
        ...
        <div className='product-details__information'>
          ...
          <h4 className="product-details__description">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic</h4>
          <h4 className="align-center">Price: $4.00</h4>
          <div>
          <button className="product-details__btn" style={{width: "100%"}}
          // onClick={}
          >Buy</button>
          </div>
        </div>
