  ...
  return (
    <footer className="footer">
      <div>
        ...
        <a className="btn linkedin_btn" href="https://www.linkedin.com/in/georgi-grigorov-ba82271b5/" role="button">
          <img src={linkedin_logo} alt="linked_image" height="40" width="40" />
        </a>
        <a className="btn github_btn" href="https://github.com/Grigorov-Georgi" role="button">
